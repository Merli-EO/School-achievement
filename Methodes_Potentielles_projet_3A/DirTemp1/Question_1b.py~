...
Data10025 = np.loadtxt("set2_output_no_0.025hz_1279208487.txt")
Data105 = np.loadtxt("set2_output_no_0.5hz_862791467.txt")
Data11 =  np.loadtxt("set2_output_no_1hz_94924870.txt")
Data125 = np.loadtxt('set2_model1')

Data20025 = np.loadtxt("set2_output_with_0.025hz_1279208487.txt")
Data205 = np.loadtxt("set2_output_with_0.5hz_862791467.txt")
Data21 =  np.loadtxt("set2_output_with_1hz_94924870.txt")
Data225 = np.loadtxt('2ièmeSet2.txt')

Max1 = len(Data11)
RangeCross = [ Data11[i][0] for i in range(Max1) ]      #Range Cross

Inline_E_amp0025 = [ Data10025[i][3] for i in range(Max1) ]  
Inline_E_phase0025 = [ Data10025[i][4] for i in range(Max1) ]  
Inline_E_amp20025 = [ Data20025[i][3] for i in range(Max1) ]  
Inline_E_phase20025 = [ Data20025[i][4] for i in range(Max1) ]  

Inline_E_amp05 = [ Data105[i][3] for i in range(Max1) ]  
Inline_E_phase05 = [ Data105[i][4] for i in range(Max1) ]  
Inline_E_amp205 = [ Data205[i][3] for i in range(Max1) ]  
Inline_E_phase205 = [ Data205[i][4] for i in range(Max1) ] 

Inline_E_amp1 = [ Data11[i][3] for i in range(Max1) ]  
Inline_E_phase1 = [ Data11[i][4] for i in range(Max1) ]  
Inline_E_amp21 = [ Data21[i][3] for i in range(Max1) ]  
Inline_E_phase21 = [ Data21[i][4] for i in range(Max1) ] 

Inline_E_amp25 = [ Data125[i][3] for i in range(Max1) ]  
Inline_E_phase25 = [ Data125[i][4] for i in range(Max1) ]  
Inline_E_amp225 = [ Data225[i][3] for i in range(Max1) ]  
Inline_E_phase225 = [ Data225[i][4] for i in range(Max1) ] 
...
plt. tight_layout()
plt.show()
fig.savefig('Question1b_plot.png')
