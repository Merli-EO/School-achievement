...
Data5000 = np.loadtxt("set2_no_5000.txt")
Data10000= np.loadtxt("set2_no_10000.txt")
Data15000 = np.loadtxt('set2_output_model1_258879614.txt')

Data25000 = np.loadtxt("set2_with_5000.txt")
Data210000 = np.loadtxt("set2_with_10000.txt")
Data215000 = np.loadtxt('set2_output_model2_258879614.txt')

Max1 = len(Data5000)


RangeCross = [ Data5000[i][0] for i in range(Max1) ]      #Range Cross
Inline_E_amp0025 = [ Data5000[i][3] for i in range(Max1) ]  
Inline_E_phase0025 = [ Data5000[i][4] for i in range(Max1) ]  
Inline_E_amp20025 = [ Data25000[i][3] for i in range(Max1) ]  
Inline_E_phase20025 = [ Data25000[i][4] for i in range(Max1) ]  

RangeCross2 = [ Data10000[i][0] for i in range(Max1) ] 
Inline_E_amp05 = [ Data10000[i][3] for i in range(Max1) ]  
Inline_E_phase05 = [ Data10000[i][4] for i in range(Max1) ]  
Inline_E_amp205 = [ Data210000[i][3] for i in range(Max1) ]  
Inline_E_phase205 = [ Data210000[i][4] for i in range(Max1) ] 

RangeCross3 = [ Data15000[i][0] for i in range(Max1) ] 
Inline_E_amp1 = [ Data15000[i][3] for i in range(Max1) ]  
Inline_E_phase1 = [ Data15000[i][4] for i in range(Max1) ]  
Inline_E_amp21 = [ Data215000[i][3] for i in range(Max1) ]  
Inline_E_phase21 = [ Data215000[i][4] for i in range(Max1) ] 
...
ax1.set_title('Inline E Amplitude', fontdict=fontTitle)
ax1.set_yscale('log')
...
ax2.set_title('Inline E Phase', fontdict=fontTitle)
...
ax3.set_title('Inline E Amplitude', fontdict=fontTitle)
ax3.set_yscale('log')
...
ax4.set_title('Inline E Phase', fontdict=fontTitle)
...
ax5.set_title('Inline E Amplitude', fontdict=fontTitle)
ax5.set_yscale('log')
...
ax6.set_title('Inline E Phase', fontdict=fontTitle)
...
plt. tight_layout()
plt.show()
fig.savefig('Question2b_plot.png')
